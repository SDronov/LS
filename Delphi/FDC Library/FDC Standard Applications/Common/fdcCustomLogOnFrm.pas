...
uses
  ...
  fdcCustomSimpleDlgFrm, fdcCustomDlgFrm, cxLookAndFeels;
...
begin
  FSession.SetUserName(edtUserName.Text);
  FSession.SetPassword(edtPassword.Text);
  FSession.SetConnectString(edtConnectString.Text);
end;
