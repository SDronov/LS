...
для Delphi 3, 4, 5, 6, 7. (только для RUNTIME при откл. Build with runtime packages)
...
доступную для Ваших русских проектов и поставить эту папку на первое место в LibraryPath.
