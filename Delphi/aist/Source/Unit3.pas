...
type
  TQueue = (btReadQueueR, btReadQueueT, btSpisQueueE1, btSpisQueueE, btSpisQueueV, btSpisQueueO, btError, btOtzivQueueS);
...
begin
  ...
  begin
     Sleep(1);
     //TLogLogger.GetRootLogger.Info('Synchronize(DoWork) TRead');
     //Synchronize(DoWork);
     DoWork;
  end;
end;
...
var
  ...
  i: integer;
begin
  //TLogLogger.GetRootLogger.Info('TReadThread.DoWork');
  fIsActive := True;
...
begin
  ...
  begin
     Sleep(1);
     //TLogLogger.GetRootLogger.Info('Synchronize(DoWork)  TSpis');
     //Synchronize(DoWork);
     DoWork;
  end;
end;
...
var
  ThList: TList;
begin
  //TLogLogger.GetRootLogger.Info('TSpisThread.DoWork');
  fIsActive := True;
