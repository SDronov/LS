...
rem Income-Accounts
echo .
echo Компиляция КПС Лицевые счета-ФТС
echo ==============================
echo .
cd "..\Income-Accounts"
call !compile.cmd
...
rem CheckCopyService
echo .
echo Компиляция сервиса взаимодействия с ТК
echo =========================================
echo .
cd "..\CheckCopyService"
call !compile.cmd
...
cd .\Bin
REM del CheckCSApp.exe iesvc.exe iacc.exe IAccFTP.exe crypt.exe SecurityMonitor.exe lgtdviewer.dll
