unit srRepCustomDeclTempNotClosedGridFrm;
...
type
  TrepCustomDeclTempNotClosedGridForm = class(TCustomDeclGridForm)
  private
...
var
  repCustomDeclTempNotClosedGridForm: TrepCustomDeclTempNotClosedGridForm;
...
initialization
    RegisterClass(TrepCustomDeclTempNotClosedGridForm);
