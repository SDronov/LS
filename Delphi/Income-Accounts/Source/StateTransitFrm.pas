...
uses
  ...
  fdcObjectLinkEdit, cxGraphics, cxCheckBox, MainDm;
...
type
  TStateTransitForm = class(TObjectForm)
    ...
    cxAccessLevel: TcxDBCheckBox;
    lciAccessLevel: TdxLayoutItem;
    dsDataTR_ACCESS_LEVEL: TFloatField;
    dsDataCONDITION: TStringField;
    edtCondition: TcxDBTextEdit;
    lciCondition: TdxLayoutItem;
