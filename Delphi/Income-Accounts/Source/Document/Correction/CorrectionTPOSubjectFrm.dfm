inherited CorrectiontpoSubjectForm: TCorrectiontpoSubjectForm
  Left = 223
  Top = 170
  Height = 600
  Caption = 'CorrectiontpoSubjectForm'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited dsData: TfdcQuery
    SQL.Strings = (
      'select *'
      '  from fdc_correction_tpo_subject_Lst'
      ' where ID = :ID')
  ...
  inherited dsInsert: TfdcQuery
    ...
    SQL.Strings = (
      'begin'
      '  :ID ::= p_correction_tpo.subject_add ('
  ...
  inherited dsUpdate: TfdcQuery
    ...
    SQL.Strings = (
      'begin'
      '  -- Call the procedure'
      '  p_correction_tpo.subject_modify( pId            => :ID'
      '                                  ,pDocNumber     => :DOC_NUMBER'
      '                                  ,pDocDate       => :DOC_DATE'
      '                                  ,pDocID         => :DOC_ID'
