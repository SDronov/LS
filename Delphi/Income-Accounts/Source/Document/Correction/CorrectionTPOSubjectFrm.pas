...
uses
  ...
  fdcObjectLinkEdit, cxMemo, cxTextEdit, cxPC, cxControls, OracleData,
  QueryList;

type
  TCorrectionTpoSubjectForm = class(TCorrectionTPOForm)
...
procedure TCorrectionTpoSubjectForm.edtSubjectNameAfterAcceptObject(
  Sender: TObject);
begin
...
initialization
  RegisterClass(TCorrectionTpoSubjectForm);
