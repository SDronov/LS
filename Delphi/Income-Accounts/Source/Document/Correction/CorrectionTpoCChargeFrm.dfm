inherited CorrectionTPOCChargeForm: TCorrectionTPOCChargeForm
  Caption = 'CorrectionTPOCChargeForm'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited dsData: TfdcQuery
    SQL.Strings = (
      'select *'
      '  from fdc_correction_tpo_ccharge_Lst'
      ' where ID = :ID')
  ...
  inherited dsInsert: TfdcQuery
    ...
    SQL.Strings = (
      'begin'
      '  -- Call the function'
      '  :ID ::= p_correction_tpo.ccharge_add( pdoctype => :TYPESYSNAME'
  ...
  inherited dsUpdate: TfdcQuery
    ...
    SQL.Strings = (
      'begin'
      '  -- Call the procedure'
      '  p_correction_tpo.ccharge_modify( pid => :id'
