...
type
  TTPOGridForm = class(TTPOBaseGridForm)
...
procedure TTPOGridForm.actAddExecute(Sender: TObject);
begin
//  inherited;
  RegisterAsWaiterFor(ObjectServices.CreateObject(SupportedTypeSysName, False, Params));
end;

procedure TTPOGridForm.grdDataDBBandedTableViewCustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val: Integer;
...
procedure TTPOGridForm.dsDataBeforeOpen(DataSet: TDataSet);
begin
