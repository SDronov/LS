...
type
  TDecPaybackPayForm = class(TDecisionPayBackForm)
...
var
  DecPaybackPayForm: TDecPaybackPayForm;

implementation

{$R *.dfm}

procedure TDecPaybackPayForm.dsDataAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TDecPaybackPayForm.FillReportParams(AWord: TWordClass);
begin
...
initialization
  ...
  RegisterClass( TDecPaybackPayForm );
