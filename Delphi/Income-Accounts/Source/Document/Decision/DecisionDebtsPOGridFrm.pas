...
type
  TDecisionDebtsPOGridForm = class(TObjectGridForm)
...
var
  DecisionDebtsPOGridForm: TDecisionDebtsPOGridForm;
...
procedure TDecisionDebtsPOGridForm.dsDataAfterOpen(DataSet: TDataSet);
begin
  inherited;

  if qryGetMode.Exec( 'id', [ParamByName( 'dec_id' ).Value] ) = 0 then
...
initialization
  RegisterClass( TDecisionDebtsPOGridForm );
