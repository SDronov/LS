inherited DecisionDebtsPOGridForm: TDecisionDebtsPOGridForm
  Caption = 'DecisionDebtsPOGridForm'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited dsData: TfdcQuery
    SQL.Strings = (
      'SELECT ( SELECT SUM( r.summa )'
      '           FROM fdc_reserved_payment_lst r'
      '           WHERE r.doc_id = :dec_id'
      
        '             AND t.id     = r.payment_id ) AS locked_for_decisio' +
        'n'
      '      ,t.id'
      '      ,t.name'
      '      ,t.shortname'
