...
type
  TDecPaybackLevyForm = class(TDecisionPayBackForm)
...
var
  DecPaybackLevyForm: TDecPaybackLevyForm;

implementation

{$R *.dfm}

procedure TDecPaybackLevyForm.dsDataAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TDecPaybackLevyForm.FillReportParams(AWord: TWordClass);
begin
...
initialization
  ...
  RegisterClass( TDecPaybackLevyForm );
