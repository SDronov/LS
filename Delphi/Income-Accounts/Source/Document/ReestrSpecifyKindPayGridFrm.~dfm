inherited ReestrSpecifyKindPayGridForm: TReestrSpecifyKindPayGridForm
  Left = 529
  Top = 182
  Width = 879
  Height = 422
  Caption = #1056#1077#1077#1089#1090#1088' '#1091#1074#1077#1076#1086#1084#1083#1077#1085#1080#1081'/'#1087#1086#1076#1090#1074#1077#1088#1078#1076#1077#1085#1080#1081' '#1086#1073' '#1091#1090#1086#1095#1085#1077#1085#1080#1080' '#1074#1080#1076#1072' '#1087#1083#1072#1090#1077#1078#1072
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited BarManager: TdxBarManager
    ...
    object dxBarButtonReestrPeriod: TdxBarButton
      Caption = #1056#1077#1077#1089#1090#1088#1099' '#1079#1072' '#1087#1077#1088#1080#1086#1076
      Category = 0
      Hint = #1056#1077#1077#1089#1090#1088#1099' '#1079#1072' '#1087#1077#1088#1080#1086#1076
      Visible = ivAlways
      OnClick = dxBarButtonReestrPeriodClick
    end
  end
  inherited dsData: TfdcQuery
    SQL.Strings = (
      ...
      '                      from fdc_state_lst'
        ...
        'SpecifyKindPay.Accepted'#39')  -- '#1055#1088#1080#1085#1103#1090
      
        '                         or (:show = 2 and sysname IN ( '#39'State.P' +
        'ackSpecifyKindPay.Send'#39', '#39'State.PackSpecifyKindPay.Conducted'#39' ))' +
        ' -- '#1054#1090#1087#1088#1072#1074#1083#1077#1085
      
        '                         or (:show = 3 and sysname = '#39'State.Pack' +
        'SpecifyKindPay.Generated'#39') -- '#1057#1092#1086#1088#1084#1080#1088#1086#1074#1072#1085
      '                     )'
      '       )'
      '      )'
      '  and ('
      '          (:custom_from = '#39'00000000'#39')'
      '          or'
      '          ('
      '           (t.ext_source = p_params.softcustomscode)'
      '           and'
      '           (p_params.CustomCode = :custom_from)'
      '          )'
      '          or'
      '          ('
      '           (t.ext_source != p_params.softcustomscode)'
      ...
      '                    where rpdl.rel_object_id = t.id'
      '                      and rpdl.object_id = dptl.id'
      '                      and dptl.customs_out_code = :custom_from'
      '                   )'
      '          )'
      '         )'
    ...
    object sqlGetNoticeCurrency: TsqlOp
      SQL.Strings = (
        'select column_value currency_id'
          ...
          'from table(p_reestr_noticespecifykindpay.get_currency_list(:pist' +
          's,:ponly_today))')
    end
    object sqlGetGNoticeCurrency: TsqlOp
      SQL.Strings = (
        'select column_value currency_id'
        
          'from table(p_reestr_gnoticespecifykindpay.get_currency_list(:pis' +
          'ts,:ponly_today))')
    end
    object sqlGetConfirmCurrency: TsqlOp
      SQL.Strings = (
        'select column_value currency_id'
          ...
          'from table(p_reestr_confirmspecifykindpay.get_currency_list(:pis' +
          'ts,:ponly_today))')
    end
    object sqlGetCNoticeCurrency: TsqlOp
      SQL.Strings = (
        'select column_value currency_id'
          ...
          'from table(p_reestr_cnoticespecifykindpay.get_currency_list(:pis' +
          'ts,:ponly_today))')
    end
  end
  object qlSQLResult: TQueryList
    ...
    object sqlGetReestrGNotice: TsqlOp
      SQL.Strings = (
        'begin'
        '  :ispresent := p_reestr_gnoticespecifykindpay.ispresent'
        '    ('
        '      pcurrency_id    => :pcurrency_id'
        '     ,pstatus_sysname => :pstatus_sysname'
        '     ,pists           => :pists'
    ...
    object sqlGetReestrNoticeBuild: TsqlOp
      SQL.Strings = (
        'begin'
        '  p_reestr_noticespecifykindpay.build_reestr'
        '   ('
        '     pcurrency_id => :pcurrency_id'
        '    ,pists        => :pists'
        '    ,ponly_today  => :ponly_today'
        '   );'
        'end;')
    end
    object sqlGetReestrGNoticeBuild: TsqlOp
      SQL.Strings = (
        'begin'
        '  p_reestr_gnoticespecifykindpay.build_reestr'
        '   ('
        '     pcurrency_id => :pcurrency_id'
        '    ,pists        => :pists'
        '    ,ponly_today  => :ponly_today'
    ...
    object sqlGetReestrConfirmBuild: TsqlOp
      SQL.Strings = (
        'begin'
        '  p_reestr_confirmspecifykindpay.build_reestr'
        '   ('
        '     pcurrency_id => :pcurrency_id'
        '    ,pists        => :pists'
        '    ,ponly_today  => :ponly_today'
    ...
    object sqlGetReestrCNoticeBuild: TsqlOp
      SQL.Strings = (
        'begin'
        '  p_reestr_cnoticespecifykindpay.build_reestr'
        '   ('
        '     pcurrency_id => :pcurrency_id'
        '    ,pists        => :pists'
        '    ,ponly_today  => :ponly_today'
    ...
    object sqlGet_is_present_deduct_not_active: TsqlOp
      SQL.Strings = (
        'begin'
          ...
          'y.is_present_deduct_not_active(:ponly_today);'
        '  if (:pis_present_deduct_not_active = 0) then'
        
          '    :pis_present_deduct_not_active := p_reestr_gnoticespecifykin' +
          'dpay.is_present_deduct_not_active(:ponly_today);'
        '    if (:pis_present_deduct_not_active = 0) then'
        
          '      :pis_present_deduct_not_active := p_reestr_confirmspecifyk' +
          'indpay.is_present_deduct_not_active(:ponly_today);'
        '      if (:pis_present_deduct_not_active = 0) then'
        
          '        :pis_present_deduct_not_active := p_reestr_cnoticespecif' +
          'ykindpay.is_present_deduct_not_active(:ponly_today);'
        '      end if;'
        '    end if;'
        '  end if;'
        'end;')
    end
    object sqlInitGNoticeStartDate: TsqlOp
      SQL.Strings = (
        'begin'
        '  p_reestr_gnoticespecifykindpay.set_start_reestr_date;'
        'end;')
    end
  end
end
