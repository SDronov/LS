inherited ActDeductionOverPayForm: TActDeductionOverPayForm
  Caption = 'ActDeductionOverPayForm'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited dsData: TfdcQuery
    SQL.Strings = (
      ...
      '      ,0 AS Summa'
        ...
        '  FROM FDC_ACT_DED_OVERPAY_LST a, fdc_subject_lst s, fdc_currenc' +
        'y_usable_lst c'
      ' WHERE a.ID = :ID'
      '   AND s.id = a.SUBJECT_ID'
      '   AND c.id = a.CURRENCY_ID'
      '')
    SourceServerObject = 'FDC_ACT_DED_OVERPAY_LST'
  end
