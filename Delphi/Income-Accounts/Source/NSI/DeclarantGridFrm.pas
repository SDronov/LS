{
  ...
  $Revision: 13180 $
  $Author: rrykunov $
  $Date: 2011-04-12 00:39:34 +0400 (Р’С‚, 12 Р°РїСЂ 2011) $
}
...
begin
  ExecuteLoader(TDeclarantLoader, 'Справочник участников ВЭД');
end;
...
begin
  ExecuteLoader(TDeclarantLoaderSbjDbf, 'Справочник участников ВЭД из ЦРСВЭД');
end;

procedure TDeclarantGridForm.actImportAccountExecute(Sender: TObject);
begin
  inherited;
  ExecuteLoader(TDeclarantAccLoader, 'Счета участников ВЭД');
end;
