inherited DebtTypesForm: TDebtTypesForm
  Caption = #1058#1080#1087' '#1079#1072#1076#1086#1083#1078#1077#1085#1085#1086#1089#1090#1080
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited dsData: TfdcQuery
    SQL.Strings = (
      'select *'
      '  from FDC_Debt_Types_LST'
      ' where ID = :ID')
  end
  inherited dsInsert: TfdcQuery
    SQL.Strings = (
      'begin'
      '  :ID ::= fdc_Debt_Types_Add('
      '    :NAME,'
      '    :CODE,'
      '    :SDate,'
      '    :EDate,'
