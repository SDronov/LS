inherited CheckSvedReviseDeductOrderLSForm: TCheckSvedReviseDeductOrderLSForm
  Left = 597
  Top = 505
  AutoSize = True
  Caption = #1057#1074#1077#1088#1082#1072' '#1089#1087#1080#1089#1072#1085#1080#1081' '#1089' '#1040#1048#1057' '#1054#1088#1076#1077#1088
  ClientHeight = 282
  ClientWidth = 536
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object xlrAvansLong: TxlReport
    ...
    XLSTemplate = 'ReviseDeductOrderLS.xls'
    DataSources = <
      item
        DataSet = dsTotals1
        Alias = 'aTotals'
