inherited repStatInInfoGridForm: TrepStatInInfoGridForm
  Left = 538
  Top = 268
  Width = 837
  Caption = #1055#1088#1080#1085#1103#1090#1099#1077' '#1088#1077#1077#1089#1090#1088#1099' '#1080#1079' '#1087#1086#1076#1095#1080#1085#1077#1085#1085#1099#1093' '#1058#1054
  PixelsPerInch = 96
  TextHeight = 13
  object cxGridData: TcxGrid [0]
    ...
    object cxGridDataDBBandedTableView: TcxGridDBBandedTableView
      ...
      object cxGridDataDBBandedTableViewNoticeSpecifyKindPay: TcxGridDBBandedColumn
        Caption = #1059#1074#1077#1076#1086#1084#1083#1077#1085#1080#1103
        DataBinding.FieldName = 'NoticeSpecifyKindPay'
        OnGetDisplayText = cxGridDataDBBandedTableViewNoticeSpecifyKindPayGetDisplayText
        Width = 101
        Position.BandIndex = 1
        Position.ColIndex = 0
        Position.RowIndex = 0
      end
      object cxGridDataDBBandedTableViewConfirmSpecifyKindPay: TcxGridDBBandedColumn
        Caption = #1055#1086#1076#1090#1074#1077#1088#1078#1076#1077#1085#1080#1103
        DataBinding.FieldName = 'ConfirmSpecifyKindPay'
        OnGetDisplayText = cxGridDataDBBandedTableViewNoticeSpecifyKindPayGetDisplayText
        Width = 128
        Position.BandIndex = 1
        Position.ColIndex = 1
      ...
      object cxGridDataDBBandedTableViewNoticeSpecifyKindPayCorr: TcxGridDBBandedColumn
        Caption = #1059#1074#1077#1076#1086#1084#1083#1077#1085#1080#1103' '#1087#1088#1080' '#1080#1079#1083#1080#1096#1085#1077#1081' '#1091#1087#1083#1072#1090#1077
        DataBinding.FieldName = 'NoticeSpecifyKindPayCorr'
        OnGetDisplayText = cxGridDataDBBandedTableViewNoticeSpecifyKindPayGetDisplayText
        Width = 222
        Position.BandIndex = 1
        Position.ColIndex = 2
      ...
      object cxGridDataDBBandedTableViewPackReturns: TcxGridDBBandedColumn
        Caption = #1042#1086#1079#1074#1088#1072#1090#1099
        DataBinding.FieldName = 'PackReturns'
        OnGetDisplayText = cxGridDataDBBandedTableViewNoticeSpecifyKindPayGetDisplayText
        Width = 91
        Position.BandIndex = 1
        Position.ColIndex = 3
      ...
      object cxGridDataDBBandedTableViewPackConfirmations: TcxGridDBBandedColumn
        Caption = #1050#1074#1080#1090#1072#1085#1094#1080#1080
        DataBinding.FieldName = 'PackConfirmations'
        OnGetDisplayText = cxGridDataDBBandedTableViewNoticeSpecifyKindPayGetDisplayText
        Width = 97
        Position.BandIndex = 1
        Position.ColIndex = 4
  ...
  inherited dsData: TfdcQuery
    ...
    SQL.Strings = (
      ...
      '      ,cust.name'
        ...
        '      ,sum((case pk.typesysname when '#39'ReestrNoticeSpecifyKindPay' +
        #39'     then 1 else 0 end)) NoticeSpecifyKindPay'
      
        '      ,sum((case pk.typesysname when '#39'ReestrConfirmSpecifyKindPa' +
        'y'#39'    then 1 else 0 end)) ConfirmSpecifyKindPay'
      
        '      ,sum((case pk.typesysname when '#39'ReestrNoticeSpecifyKindPay' +
        'Corr'#39' then 1 else 0 end)) NoticeSpecifyKindPayCorr'
      
        '      ,sum((case pk.typesysname when '#39'DocPackReturns'#39'           ' +
        '      then 1 else 0 end)) PackReturns'
      
        '      ,sum((case pk.typesysname when '#39'DocPackConfirmations'#39'     ' +
        '      then 1 else 0 end)) PackConfirmations'
      'from ('
      '      select id'
      '            ,customs_code_8'
      '            ,name'
      ...
      '          ,fdc_document_lst dl'
        ...
        ' sysname in ('#39'State.DocPackTransferIN.Received'#39','#39'State.DocPackTr' +
        'ansferIN.Worked'#39'))'
      
        '        AND dptl.income_date between trunc(:adate) and trunc(:ad' +
        'ate)+1-1/24/3600'
