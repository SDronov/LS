...
//--  Отчет по платежам, произведенным с применением МК (МПС) (Мультисервисная платежная система)
function ExecReportPayMK_MPS(Session : TOracleSession): boolean;
//--  Отчет по платежам, произведенным с применением микропроцессорных карт (Таможенная Платежная Система)
function ExecReportPayMK_TPS(Session : TOracleSession): boolean;
//--  Отчет по платежам, произведенным с применением микропроцессорных карт (Таможенная Карта)
