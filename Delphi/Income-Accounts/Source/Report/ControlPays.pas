...
type
  TCheckSvedControlPaysForm = class(TfdcCustomDlgForm)
...
function  ExecReport(Session: TOracleSession): Boolean;
var
  F: TCheckSvedControlPaysForm;
begin
  F := TCheckSvedControlPaysForm.Create(nil);
  with F do
  try
    // --- init Sessions
...
procedure TCheckSvedControlPaysForm.FormCreate(Sender: TObject);
begin
  inherited;
  dxMemData.Open;
  dxMemData.Insert;
...
procedure TCheckSvedControlPaysForm.actOkExecute(Sender: TObject);
begin
