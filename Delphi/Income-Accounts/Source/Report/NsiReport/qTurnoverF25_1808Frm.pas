...
type
  TqTurnoverF25_1808Form = class(TCustomTurnoverSheetForm)
...
function TqTurnoverF25_1808Form.GetAccountCode : string;
begin
  Result := 'Р12.10.00'
end;

function TqTurnoverF25_1808Form.GetAppendixNo : string;
begin
  Result := '0';
end;

function TqTurnoverF25_1808Form.GetFormNo : string;
begin
  Result := '25';
end;

function TqTurnoverF25_1808Form.GetXLSName : string;
begin
  Result := 'OB_F25_1808.xls';
end;

procedure TqTurnoverF25_1808Form.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TqTurnoverF25_1808Form.dsetDataBeforeQuery(
...
procedure TqTurnoverF25_1808Form.grdTurnoverSheetDBBandedTableViewCustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
  inherited;
...
procedure TqTurnoverF25_1808Form.grdTurnoverSheetDBBandedTableViewDataControllerFilterChanged(
  Sender: TObject);
begin
  inherited;
...
procedure TqTurnoverF25_1808Form.dsetDataAfterClose(DataSet: TDataSet);
begin
  inherited;
  dsetItog.Close;
end;

procedure TqTurnoverF25_1808Form.dsetItogBeforeQuery(
  Sender: TOracleDataSet);
var
  I: Integer;
  F: TField;
...
procedure TqTurnoverF25_1808Form.dsetDataAfterQuery(
  Sender: TOracleDataSet);
begin
  inherited;
...
function TqTurnoverF25_1808Form.GetXLSDetailName: string;
begin
  Result := 'OB_Detail_by_KBK.xls';
end;

initialization
  RegisterTurnoverSheetClass ( TqTurnoverF25_1808Form , 'OB_F25_1808');
