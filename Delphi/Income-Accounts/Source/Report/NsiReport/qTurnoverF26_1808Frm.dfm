inherited qTurnoverF26_1808Form: TqTurnoverF26_1808Form
  Left = 298
  Top = 256
  Width = 854
  ...
  inherited dsetData: TOracleDataSet
    SQL.Strings = (
      ...
      '      ,return'
        ...
        '      ,(in_summa + postupilo + kbk100 - itogo_out - confirmkindp' +
        'ay - return) out_summa'
      'from ('
      ...
      '                        ,dl.doc_date doc_date'
        ...
        '                        ,(case  when (acc.code =  '#39#1060'01.10.01'#39' an' +
        'd acct.is_debit = '#39'Y'#39') then sum_rur else 0 end) postupilo'
      
        '                        ,(case  when (acc.code =  '#39#1060'01.10.02'#39' an' +
        'd  acct.is_debit = '#39'Y'#39') then sum_rur else 0 end) kbk100'
        ...
        '                        ,-(case  when (acc.code = '#39#1060'01.10.04'#39' an' +
        'd acct.is_debit = '#39'N'#39' and dl.typesysname = '#39'ReestrConfirmSpecify' +
        'KindPay'#39') then sum_rur else 0 end) confirmkindpay'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0052455455524E0100000000000900000049544F474F5F4F5554010000000000
      090000004F55545F53554D4D4101000000000002000000494401000000000008
      000000504152454E54494401000000000009000000504F53545550494C4F0100
      00000000060000004B424B313030010000000000}
