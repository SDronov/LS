...
type
  TqTurnoverF16_1808Form = class(TCustomTurnoverSheetForm)
    ...
    grdTurnoverSheetDBBandedTableD2ViewRRETURN: TcxGridDBColumn;
    grdTurnoverSheetDBBandedTableDViewRRETURN: TcxGridDBColumn;
    grdTurnoverSheetDBBandedTableDViewRETURN: TcxGridDBColumn;
    grdTurnoverSheetDBBandedTableDViewREUSE: TcxGridDBColumn;
    grdTurnoverSheetDBBandedTableD2ViewREUSE: TcxGridDBColumn;
    ...
    dsetItogSubjectDOC_TYPE: TStringField;
    dsetItogSubjectDOC_NUMBER: TStringField;
    dsetItogSubjectDOC_DATE: TDateTimeField;
    dsetItogSubjectRETURN: TFloatField;
    dsetItogSubjectRRETURN: TFloatField;
    dsetItogSubjectREUSE_OUT: TFloatField;
    dsetItogSubjectOUT_SUMMA: TFloatField;
    grdTurnoverSheetDBBandedTableD2ViewDOC_TYPE: TcxGridDBColumn;
  ...
  private
    fAccountID : integer; // 09.01.00
    fAccountReuseID : integer; // 09.02.00
  protected
...
function TqTurnoverF16_1808Form.GetAccountCode : string;
begin
  Result := '09.01.00'
end;

function TqTurnoverF16_1808Form.GetAccountReuseCode : string;
begin
  Result := '09.02.00'
end;

function TqTurnoverF16_1808Form.GetAppendixNo : string;
begin
  Result := '18';
end;

function TqTurnoverF16_1808Form.GetFormNo : string;
begin
  Result := '16';
end;

function TqTurnoverF16_1808Form.GetXLSName : string;
begin
  Result := 'OB_F16_1808.xls';
end;

procedure TqTurnoverF16_1808Form.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TqTurnoverF16_1808Form.dsetDataBeforeQuery(
...
procedure TqTurnoverF16_1808Form.grdTurnoverSheetDBBandedTableViewCustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
  inherited;
...
procedure TqTurnoverF16_1808Form.grdTurnoverSheetDBBandedTableViewDataControllerFilterChanged(
  Sender: TObject);
begin
  inherited;
...
procedure TqTurnoverF16_1808Form.dsetDataAfterClose(DataSet: TDataSet);
begin
  inherited;
  dsetItog.Close;
end;

procedure TqTurnoverF16_1808Form.dsetItogBeforeQuery(
  Sender: TOracleDataSet);
var
  I: Integer;
  F: TField;
...
procedure TqTurnoverF16_1808Form.dsetDataAfterQuery(
  Sender: TOracleDataSet);
begin
  inherited;
...
function TqTurnoverF16_1808Form.GetXLSDetailName: string;
begin
...
initialization
  RegisterTurnoverSheetClass ( TqTurnoverF16_1808Form , 'OB_F16_1808');
