...
type
  TqTurnoverF21_1808Form = class(TCustomTurnoverSheetForm)
...
function TqTurnoverF21_1808Form.GetAccountCode : string;
begin
  Result := 'Р01.00.00'
end;

function TqTurnoverF21_1808Form.GetAppendixNo : string;
begin
  Result := '0';
end;

function TqTurnoverF21_1808Form.GetFormNo : string;
begin
  Result := '0';
end;

function TqTurnoverF21_1808Form.GetXLSName : string;
begin
  Result := 'OB_F21_1808.xls';
end;

procedure TqTurnoverF21_1808Form.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TqTurnoverF21_1808Form.dsetDataBeforeQuery(
...
procedure TqTurnoverF21_1808Form.grdTurnoverSheetDBBandedTableViewCustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
  inherited;
...
procedure TqTurnoverF21_1808Form.grdTurnoverSheetDBBandedTableViewDataControllerFilterChanged(
  Sender: TObject);
begin
  inherited;
...
procedure TqTurnoverF21_1808Form.dsetDataAfterClose(DataSet: TDataSet);
begin
  inherited;
  dsetItog.Close;
end;

procedure TqTurnoverF21_1808Form.dsetItogBeforeQuery(
  Sender: TOracleDataSet);
var
  I: Integer;
  F: TField;
...
procedure TqTurnoverF21_1808Form.dsetDataAfterQuery(
  Sender: TOracleDataSet);
begin
  inherited;
...
initialization
  RegisterTurnoverSheetClass ( TqTurnoverF21_1808Form , 'OB_F21_1808');
