inherited qTurnoverF23_1808Form: TqTurnoverF23_1808Form
  Left = 298
  Top = 256
  Width = 854
  Caption = #1089#1095' '#1056'06.20.00'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited grdTurnoverSheet: TcxGrid
    ...
    inherited grdTurnoverSheetDBBandedTableView: TcxGridDBBandedTableView
      ...
      Bands = <
        ...
        item
          Caption = #1047#1072#1095#1090#1077#1085#1086' '#1089' '#1076#1088'.  '#1090#1072#1084#1086#1078#1085#1080
          Position.BandIndex = 4
          Position.ColIndex = 1
          Width = 143
        end
      ...
      object grdTurnoverSheetDBBandedTableViewReuse_out_totam: TcxGridDBBandedColumn
        Caption = '17'
        DataBinding.FieldName = 'REUSE_OUT_TOTAM'
        Options.Filtering = False
        Options.FilteringMRUItemsList = False
    ...
    object grdTurnoverSheetDBBandedTableDView: TcxGridDBTableView [1]
      ...
      object grdTurnoverSheetDBBandedTableDViewReuse_out_totam: TcxGridDBBandedColumn
        Caption = #1047#1072#1095#1077#1090' '#1085#1072' '#1076#1088'. '#1090#1072#1084#1086#1078#1085#1102
        DataBinding.FieldName = 'REUSE_OUT_TOTAM'
        Options.Filtering = False
        Options.FilteringMRUItemsList = False
    ...
    object grdTurnoverSheetDBBandedTableD2View: TcxGridDBTableView [2]
      ...
      object grdTurnoverSheetDBBandedTableD2ViewReuse_out_totam: TcxGridDBBandedColumn
        Caption = #1047#1072#1095#1077#1090' '#1085#1072' '#1076#1088'. '#1090#1072#1084#1086#1078#1085#1102
        DataBinding.FieldName = 'REUSE_OUT_TOTAM'
        Options.Filtering = False
        Options.FilteringMRUItemsList = False
  ...
  inherited PanelHeading: TPanel
    Width = 846
    Caption = 
      #1054#1073#1086#1088#1086#1090#1085#1072#1103' '#1074#1077#1076#1086#1084#1086#1089#1090#1100' '#1087#1086' '#1089#1095#1077#1090#1091' '#1056'.06.20.00 "'#1056#1072#1089#1087#1088#1077#1076#1077#1083#1077#1085#1085#1099#1077' '#1076#1077#1085#1077#1078#1085#1099#1077 +
  ...
  inherited dsetData: TOracleDataSet
    SQL.Strings = (
      ...
      '      ,to_number(null) reuse_out_totam'
      ...
      '      ,sum(reuse_out_totam) reuse_out_totam'
      'from ('
      ...
      '                        ,dic.code kbk'
        ...
        '                        ,(case  when (acc.code in('#39#1056'06.20.01'#39','#39#1056 +
        '06.20.02'#39','#39#1056'06.20.03'#39','#39#1056'06.20.04'#39') and  acct.is_debit = '#39'Y'#39' and ' +
        'dl.typesysname in ('#39'CashlessPaymentOrder'#39','#39'PaymentOrderRestUFK'#39')' +
        ') then sum_rur else 0 end) postupilo'
      
        '                        ,(case  when (acc.code in('#39#1056'06.20.01'#39','#39#1056 +
        '06.20.02'#39','#39#1056'06.20.03'#39','#39#1056'06.20.04'#39') and  acct.is_debit = '#39'Y'#39' and ' +
        'dl.typesysname in ('#39'DocReuse'#39','#39'DocReuseY'#39') and substr(dr.customs' +
        '_code_old,1,3) != substr(p_params.customcode,1,3)) then sum_rur ' +
        'else 0 end) reuse_in'
      
        '                        ,-(case  when (acc.code in('#39#1056'06.20.02'#39','#39 +
        #1056'06.20.03'#39','#39#1056'06.20.04'#39') and acct.is_debit = '#39'N'#39' and rskl.typesys' +
        'name = '#39'ReestrNoticeSpecifyKindPay'#39' and dic.code = p_params.prep' +
        'aymentkbk) then sum_rur else 0 end) noticekindpay_avans'
      
        '                        ,(case  when (acc.code = '#39#1056'12.10.01'#39' and' +
        ...
        '                        ,(case  when (acc.code = '#39#1056'12.10.02'#39' and' +
        ' acct.is_debit = '#39'Y'#39') then sum_rur else 0 end) noticekindpay_cel' +
        'evoy_t'
      
        '                        ,(case  when (acc.code in('#39#1056'06.20.02'#39','#39#1056 +
        '06.20.03'#39','#39#1056'06.20.04'#39') and acct.is_debit = '#39'N'#39' and rskl.typesysn' +
        'ame = '#39'ReestrNoticeSpecifyKindPayCorr'#39') then sum_rur else 0 end)' +
        ' cnoticekindpay_t'
      
        '                        ,-(case  when (acc.code = '#39#1056'12.10.03'#39' an' +
        ...
        '                        ,-(case  when (acc.code in('#39#1056'06.20.02'#39','#39 +
        #1056'06.20.03'#39','#39#1056'06.20.04'#39') and  acct.is_debit = '#39'N'#39' and dl.typesysn' +
        'ame in ('#39'Payment_Order_PayBack'#39','#39'CancelDecisionPayback'#39')) then s' +
        'um_rur else 0 end) return'
      
        '                        ,-(case  when (acc.code in('#39#1056'06.20.02'#39','#39 +
        #1056'06.20.03'#39','#39#1056'06.20.04'#39') and  acct.is_debit = '#39'N'#39' and dl.typesysn' +
        'ame in ('#39'DocReuse'#39','#39'DocReuseY'#39') and substr(dr.customs_code_new,1' +
        ',3) != substr(p_params.customcode,1,3)) then sum_rur else 0 end)' +
        ' Reuse_out_tortu'
      
        '                        ,(case when (acct.is_debit = '#39'N'#39') then -' +
        '1 else +1 end)*(case  when (acc.code in('#39#1056'06.20.02'#39','#39#1056'06.20.03'#39',' +
        #39#1056'06.20.04'#39') and  dl.typesysname in ('#39'DocReuse'#39','#39'DocReuseY'#39') and' +
        ' substr(dr.customs_code_old,1,3) = substr(p_params.customcode,1,' +
        '3)) then sum_rur else 0 end) Reuse_out_totam'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      550100000000000F00000052455553455F4F55545F544F54414D010000000000}
    ...
    object dsetDataREUSE_OUT_TOTAM: TFloatField
      FieldName = 'REUSE_OUT_TOTAM'
      DisplayFormat = ',0.00'
    end
  end
  ...
  object dsetItog: TOracleDataSet
    SQL.Strings = (
      ...
      '                  ,nvl(sum(reuse_out_totam),0) reuse_out_totam'
      '            from ('
      '                  select acct.kbk_id'
      '                        ,acct.subject_id subject_id'
      '                        ,acct.account_id'
    ...
    object dsetItogREUSE_OUT_TOTAM: TFloatField
      FieldName = 'REUSE_OUT_TOTAM'
      DisplayFormat = ',0.00'
    end
  end
  ...
  object dsetItogSubject: TOracleDataSet
    ...
    object dsetItogSubjectREUSE_OUT_TOTAM: TFloatField
      FieldName = 'REUSE_OUT_TOTAM'
      DisplayFormat = ',0.00'
    end
  end
