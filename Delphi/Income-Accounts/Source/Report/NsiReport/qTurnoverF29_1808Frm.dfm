inherited qTurnoverF29_1808Form: TqTurnoverF29_1808Form
  Left = 298
  Top = 256
  Width = 854
  Caption = #1089#1095' '#1060'09.00.00'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited PanelHeading: TPanel
    Width = 846
    Caption = #1054#1073#1086#1088#1086#1090#1085#1072#1103' '#1074#1077#1076#1086#1084#1086#1089#1090#1100' '#1087#1086' '#1089#1095#1077#1090#1072#1084' '#1060'.09.00.00 "'#1056#1077#1077#1089#1090#1088#1099' '#1085#1072' '#1074#1086#1079#1074#1088#1072#1090'"'
  end
  inherited dsetData: TOracleDataSet
    SQL.Strings = (
      ...
      '      ,parentid '
        ...
        'hen '#39#1048#1090#1086#1075#1086' '#1087#1086' '#1090#1072#1084#1086#1078#1077#1085#1085#1086#1084#1091' '#1086#1088#1075#1072#1085#1091#39
      ...
      '      ,item_no item_no_sort'
        ...
        ',0,'#39'rur'#39','#39'rur'#39',0,:ists)'
      
        '             when (item_no is null and subject_id is not null) t' +
        'hen p_oborotki.get_bsumma_account_subject(:account_id,:account_c' +
        'ode,trunc(:bdate),subject_id,0,'#39'rur'#39','#39'rur'#39',0,:ists)'
      '             else in_summa'
      '       end) in_summa'
      '      ,customname'
      '      ,doc_number'
      ...
      'from ('
        ...
        '      select (customname||'#39'|'#39'||to_char(subject_id)||'#39'|'#39'||doc_num' +
        'ber||'#39'|'#39'||to_date(doc_date,'#39'dd.mm.yyyy'#39')) id'
      '            ,(customname||'#39'|'#39'||to_char(subject_id)) parentid'
      
        '            ,row_number() over(order by customname, subject_id, ' +
        'doc_number, doc_date) item_no'
