inherited qTurnoverF25_1808Form: TqTurnoverF25_1808Form
  Left = 298
  Top = 256
  Width = 854
  Caption = #1089#1095' '#1056'12.10.00'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited grdTurnoverSheetDBBandedTableView: TcxGridDBBandedTableView
      ...
      DataController.Summary.DefaultGroupSummaryItems = <
        item
          ...
          Kind = skSum
          Position = spFooter
          Column = grdTurnoverSheetDBBandedTableViewIN_SUMMA_ITOGO
        end
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
        ...
        item
          ...
          Kind = skSum
          Position = spFooter
          Column = grdTurnoverSheetDBBandedTableViewdebit
        end
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
        ...
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
          Column = grdTurnoverSheetDBBandedTableViewOut_summa_itogo
        end
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
    ...
    object grdTurnoverSheetDBBandedTableDView: TcxGridDBTableView [1]
      ...
      DataController.Summary.DefaultGroupSummaryItems = <
        item
          ...
          Kind = skSum
          Position = spFooter
          Column = grdTurnoverSheetDBBandedTableDViewIN_SUMMA_ITOGO
        end
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
        ...
        item
          ...
          Kind = skSum
          Position = spFooter
          Column = grdTurnoverSheetDBBandedTableDViewdebit
        end
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
        ...
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
          Column = grdTurnoverSheetDBBandedTableDViewOUT_SUMMA_ITOGO
        end
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
    ...
    object grdTurnoverSheetDBBandedTableD2View: TcxGridDBTableView [2]
      ...
      DataController.Summary.DefaultGroupSummaryItems = <
        item
          ...
          Kind = skSum
          Position = spFooter
          Column = grdTurnoverSheetDBBandedTableD2ViewIN_SUMMA_ITOGO
        end
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
        ...
        item
          ...
          Kind = skSum
          Position = spFooter
          Column = grdTurnoverSheetDBBandedTableD2Viewdebit
        end
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
        ...
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
          Column = grdTurnoverSheetDBBandedTableD2ViewOUT_SUMMA_ITOGO
        end
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
  ...
  inherited PanelHeading: TPanel
    Width = 846
    Caption = 
      #1054#1073#1086#1088#1086#1090#1085#1072#1103' '#1074#1077#1076#1086#1084#1086#1089#1090#1100' '#1087#1086' '#1089#1095#1077#1090#1072#1084' '#1056'.12.10.00 "'#1055#1088#1080#1077#1084' '#1088#1077#1077#1089#1090#1088#1086#1074' '#1091#1074#1077#1076#1086#1084#1083 +
  ...
  inherited dsetData: TOracleDataSet
    SQL.Strings = (
      ...
      '                        ,acct.operation_date'
        ...
        '                        ,(case acc.code when '#39#1056'12.10.01'#39' then '#39#1059 +
        #1074#1040#39' when '#39#1056'12.10.02'#39' then '#39#1059#1074#1062#39' when '#39#1056'12.10.03'#39' then '#39#1059#1074#1048#1079#1083#39' wh' +
        'en '#39#1056'12.10.04'#39' then '#39#1055#39' else '#39#1085#1077' '#1086#1087#1088#1077#1076#1077#1083#1077#1085#1086#39' end) doctype'
      
        '                        ,p_oborotki.get_kbk_code(acct.kbk_id) kb' +
        'k'
      
        '                        ,(case WHEN acct.is_debit = '#39'Y'#39' then +1 ' +
  ...
  object dsetItogDocType: TOracleDataSet
    SQL.Strings = (
      ...
      '                        ,acct.operation_date'
        ...
        '                        ,(case acc.code when '#39#1056'12.10.01'#39' then '#39#1059 +
        #1074#1040#39' when '#39#1056'12.10.02'#39' then '#39#1059#1074#1062#39' when '#39#1056'12.10.03'#39' then '#39#1059#1074#1048#1079#1083#39' wh' +
        'en '#39#1056'12.10.04'#39' then '#39#1055#39' else '#39#39' end) doctype'
