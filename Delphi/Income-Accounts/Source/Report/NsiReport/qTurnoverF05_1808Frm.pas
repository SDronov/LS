...
type
  TqTurnoverF05_1808Form = class(TCustomTurnoverSheetForm)
...
function TqTurnoverF05_1808Form.GetAccountCode : string;
begin
  Result := '01.03.02'
end;

function TqTurnoverF05_1808Form.GetAppendixNo : string;
begin
  Result := '7';
end;

function TqTurnoverF05_1808Form.GetFormNo : string;
begin
  Result := '5';
end;

function TqTurnoverF05_1808Form.GetXLSName : string;
begin
  Result := 'OB_F05_1808.xls';
end;

procedure TqTurnoverF05_1808Form.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TqTurnoverF05_1808Form.dsetDataBeforeQuery(
...
procedure TqTurnoverF05_1808Form.grdTurnoverSheetDBBandedTableViewCustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
  inherited;
...
procedure TqTurnoverF05_1808Form.grdTurnoverSheetDBBandedTableViewDataControllerFilterChanged(
  Sender: TObject);
begin
  inherited;
...
procedure TqTurnoverF05_1808Form.dsetDataAfterClose(DataSet: TDataSet);
begin
  inherited;
  dsetItog.Close;
end;

procedure TqTurnoverF05_1808Form.dsetItogBeforeQuery(
  Sender: TOracleDataSet);
var
  I: Integer;
  F: TField;
...
procedure TqTurnoverF05_1808Form.dsetDataAfterQuery(
  Sender: TOracleDataSet);
begin
  inherited;
...
initialization
  RegisterTurnoverSheetClass ( TqTurnoverF05_1808Form , 'OB_F05_1808');
