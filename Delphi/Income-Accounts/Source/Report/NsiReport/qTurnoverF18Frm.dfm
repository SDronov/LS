inherited qTurnoverF18Form: TqTurnoverF18Form
  Left = 231
  Top = 245
  Width = 854
  Caption = #1089#1095' 03.05.00.'#1079#1072#1073
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited grdTurnoverSheet: TcxGrid
    ...
    inherited grdTurnoverSheetDBBandedTableView: TcxGridDBBandedTableView
      ...
      Bands = <
        ...
        item
          Caption = #1048#1089#1093#1086#1076#1103#1097#1080#1081' '#1086#1089#1090#1072#1090#1086#1082' '#1091#1074#1077#1076#1086#1084#1083#1077#1085#1080#1081' '#1086#1073' '#1091#1090#1086#1095#1085#1077#1085#1080#1080
          FixedKind = fkRight
          Width = 300
        end
        item
      ...
      object grdTurnoverSheetDBBandedTableViewIn_summa_extpay: TcxGridDBBandedColumn
        Caption = '5'
      ...
      object grdTurnoverSheetDBBandedTableViewFio: TcxGridDBBandedColumn
        Caption = '8'
      ...
      object grdTurnoverSheetDBBandedTableViewNach_KBK: TcxGridDBBandedColumn
        Caption = '10'
