...
type
  TqTurnoverF27_1808Form = class(TCustomTurnoverSheetForm)
    ...
    grdTurnoverSheetDBBandedTableViewITOGO_OUT_KBK_S: TcxGridDBBandedColumn;
    grdTurnoverSheetDBBandedTableViewITOGO_OUT_KBK_T: TcxGridDBBandedColumn;
    ...
    grdTurnoverSheetDBBandedTableDViewITOGO_OUT_KBK_T: TcxGridDBColumn;
    grdTurnoverSheetDBBandedTableDViewITOGO_OUT_KBK_S: TcxGridDBColumn;
    ...
    dsetDataITOGO_OUT_KBK_S: TFloatField;
    dsetDataITOGO_OUT_KBK_T: TFloatField;
    dsetItogKBK100: TFloatField;
    dsetItogITOGO_OUT_KBK_S: TFloatField;
    dsetItogITOGO_OUT_KBK_T: TFloatField;
    grdTurnoverSheetDBBandedTableViewRETURN: TcxGridDBBandedColumn;
    grdTurnoverSheetDBBandedTableDViewKBK100: TcxGridDBColumn;
...
function TqTurnoverF27_1808Form.GetAccountCode : string;
begin
  Result := 'Ф01.00.00'
end;

function TqTurnoverF27_1808Form.GetAppendixNo : string;
begin
  Result := '0';
end;

function TqTurnoverF27_1808Form.GetFormNo : string;
begin
  Result := '0';
end;

function TqTurnoverF27_1808Form.GetXLSName : string;
begin
  Result := 'OB_F27_1808.xls';
end;

procedure TqTurnoverF27_1808Form.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TqTurnoverF27_1808Form.dsetDataBeforeQuery(
...
procedure TqTurnoverF27_1808Form.grdTurnoverSheetDBBandedTableViewCustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
  inherited;
...
procedure TqTurnoverF27_1808Form.grdTurnoverSheetDBBandedTableViewDataControllerFilterChanged(
  Sender: TObject);
begin
  inherited;
...
procedure TqTurnoverF27_1808Form.dsetDataAfterClose(DataSet: TDataSet);
begin
  inherited;
  dsetItog.Close;
end;

procedure TqTurnoverF27_1808Form.dsetItogBeforeQuery(
  Sender: TOracleDataSet);
var
  I: Integer;
  F: TField;
...
procedure TqTurnoverF27_1808Form.dsetDataAfterQuery(
  Sender: TOracleDataSet);
begin
  inherited;
...
function TqTurnoverF27_1808Form.GetXLSDetailName: string;
begin
  Result := 'OB_Detail_by_KBK.xls';
end;

initialization
  RegisterTurnoverSheetClass ( TqTurnoverF27_1808Form , 'OB_F27_1808');
