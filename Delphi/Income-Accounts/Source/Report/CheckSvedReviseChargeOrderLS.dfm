inherited CheckSvedReviseChargeOrderLSForm: TCheckSvedReviseChargeOrderLSForm
  Left = 433
  Top = 452
  AutoSize = True
  Caption = #1057#1074#1077#1088#1082#1072' '#1085#1072#1095#1080#1089#1083#1077#1085#1080#1081' '#1089' '#1040#1048#1057' '#1054#1088#1076#1077#1088
  ClientHeight = 280
  ClientWidth = 536
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object xlrAvansLong: TxlReport
    ...
    XLSTemplate = 'ReviseChargeOrderLS.xls'
    DataSources = <
      item
        DataSet = dsTotals1
        Alias = 'aTotals'
