inherited CheckSvedReviseChargeAistLSForm: TCheckSvedReviseChargeAistLSForm
  Left = 396
  Top = 586
  Caption = #1057#1074#1077#1088#1082#1072' '#1085#1072#1095#1080#1089#1083#1077#1085#1080#1081' '#1089' '#1040#1048#1057' '#1040#1048#1057#1058'-'#1052
  ClientHeight = 280
  ClientWidth = 536
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object xlrAvansLong: TxlReport
    ...
    XLSTemplate = 'ReviseChargeAistLS.xls'
    DataSources = <
      item
        DataSet = dsTotals1
        Alias = 'aTotals'
