inherited qCheckTRNoForm: TqCheckTRNoForm
  Left = 440
  Top = 378
  Caption = #1050#1086#1085#1090#1088#1086#1083#1100' '#1085#1086#1084#1077#1088#1086#1074' T'#1056
  ClientHeight = 170
  ClientWidth = 246
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object xlReport: TxlReport
    ...
    XLSTemplate = 'report\'#1050#1086#1085#1090#1088#1086#1083#1100' '#1085#1086#1084#1077#1088#1086#1074' '#1058#1056'.xls'
    DataSources = <
      item
        DataSet = dsData
        Alias = 'dsData'
  ...
  object dsData: TOracleDataSet
    SQL.Strings = (
      ...
      '       '#39#1058#1056'-'#39'||lpad(:MinNo,7,'#39'0'#39') M_N, '
      '       '#39#1058#1056'-'#39'||lpad(:MaxNo,7,'#39'0'#39') M_X'
      'from fdc_tr_lst d'
