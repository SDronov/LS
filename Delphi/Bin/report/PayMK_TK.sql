...
from (
      ...
      where ( (instr(upper(note),'ÊÀÐÒ',1) > 0) and ( (instr(note,'N 603714',1) > 0) or (instr(note,'N 639575',1) > 0) ) )
...
from (select custom.name    custom_name,
 ...
 where p_params.customlevel = 2
   ...
   and (substr(poc.cardnum, 1, 6) = '603714' or substr(poc.cardnum, 1, 6) = '639575')
