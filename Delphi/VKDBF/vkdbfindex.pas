...
type
  ...
  TOnSubIndex = procedure(Sender: TObject; var ItemKey: String; RecordNum: DWORD; var ExitCode: Integer) of object;
  ...
  private
    FCustomCollatingSequence: String;
    FCollationType: TVKCollationTypes;
  public
    constructor Create;
  published
    property CollationType: TVKCollationTypes read FCollationType write FCollationType;
    property CustomCollatingSequence: String read FCustomCollatingSequence write FCustomCollatingSequence;
  end;
