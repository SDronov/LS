...
type
  ...
  CDX_HEADER = packed Record
    ...
    charset:    array [0..7] of Char;                                   //494   8
    ...
    key_pool:   array[0..pred(CDX_BUFFER_SIZE)] of Char;                //512   512
  end;                                                                  //1024
    ...
    case Byte of                                                        //12
      0:(
        ...
        compact_data:         {Data pool for compact recno+dups+trail}  //24    488
          array [0..pred(COMPACT_DATA_POOL_SIZE)] of Char;
        );
      1:(
        data_pool:            {Data pool for recno+key}                 //12    500
          array [0..pred(DATA_POOL_SIZE)] of Char;
        );
  end;                                                                  //512
