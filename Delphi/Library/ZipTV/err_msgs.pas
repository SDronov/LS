...
Const
   ...
   E_FWRITE = E_BASE + 36;
   E_FOVERWRITE = E_BASE + 37;
   E_CABSETERR = E_BASE + 40;
   E_FCLOSE = E_BASE + 42;
   E_CODESET = E_BASE + 44;
   E_CMDLINE = E_BASE + 45;
   E_CORRUPTINPUT = E_BASE + 46;
   ...
   E_DIRPROTECTED = E_BASE + 71;
   E_DRVPROTECTED = E_BASE + 72;
   E_NOEOF = E_BASE + 73;               (* RAR *)
   E_EOF = E_BASE + 76;                 (* UUE *)
   E_EOL = E_BASE + 77;                 (* UUE *)
   ...
   E_NOSQXDLL = E_BASE + 163;
   E_MULTIVOL = E_BASE + 164;
   E_MULTIPARTGZIP = E_BASE + 165;
   E_NESTDIR = E_BASE + 166;
   E_NODECODE = E_BASE + 167;
   E_NOPASSWORD = E_BASE + 168;         (* added in version 4.0 *)
	E_NOENCRYPTION = E_BASE + 170;
   E_NOTHINGTODO = E_BASE + 172;
   E_PERMISSIONS = E_BASE + 174;
   E_REGPERMISSIONS = E_BASE + 175;
   E_REQUIREDEVENT = E_BASE + 177;
   E_REQUIREDPROPERTY = E_BASE + 178;
   E_QUOTESYNTAX = E_BASE + 180;
   E_PARANSYNTAX = E_BASE + 181;
   E_PROTECTED = E_BASE + 190;
   E_REGERROR = E_BASE + 191;
   E_REGERROR_VOL = E_BASE + 192;
   E_SEEKERR = E_BASE + 193;
   E_SHANNONFANO = E_BASE + 194;
   E_SHNODESKTOP = E_BASE + 195;
   E_SHSPECFOLDR = E_BASE + 196;
   E_SHMEMALLOC = E_BASE + 197;
   E_SIZETOSMALL = E_BASE + 198;        (* ztvArchiveSplitter *)
   E_SIZETOBIG = E_BASE + 199;
   E_SRCHMODE = E_BASE + 203;
   E_STACK = E_BASE + 205;
   E_STREAMERROR = E_BASE + 210;
   E_STREAMSUPPORT = E_BASE + 224;
   E_TIMERERROR = E_BASE + 225;
   E_UNKNMETH = E_BASE + 226;
	E_ENCRYPTION = E_BASE + 227;
   E_UNKNTYPE = E_BASE + 228;
   E_UNKNVERS = E_BASE + 229;
   E_UPDATE = E_BASE + 250;
